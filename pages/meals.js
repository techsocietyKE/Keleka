...
const Meals = () => {
  ...
  useEffect(() => {
    ...
    const filtered = meals.filter(meal => meal.name.toLowerCase().includes(lowerCaseSearchTerm));
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex justify-between items-center mb-6">
          ...
          <input
            ...
            className="w-full py-2 px-2 border border-gray-300 rounded-lg focus:outline-none"
          />
          </div>
          <div>
          </div>
              ...
              {filteredMeals.length > 0 ? (
                filteredMeals.map((meal) => (
                  <tr key={meal._id} className="border-b border-gray-200 hover:bg-gray-100">
                    ...
                    <td className="py-3 px-6 text-left">Ksh {''}
                    ...
                    <td className="py-3 px-6 text-left">{meal.createdBy}</td>
                    <td className="py-3 px-6 text-center">
                      <div className="flex item-center justify-center gap-3">
                        ...
                        <Link href={'/meals/delete/' + meal._id} className="text-red-600 hover:text-red-800">
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                            <path strokeLinecap="round" strokeLinejoin="round" d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.246 2.077H8.086a2.25 2.25 0 0 1-2.245-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 1-15.228 0m15.228 0c-.334-.052-.668-.105-1.002-.155m-1.022.155A48.108 48.108 0 0 0 4.772 5.79" />
                          </svg>
                        </Link>
                      </div>
                    </td>
...
export default withAuth(Meals,  ["Admin", "Staff"]);
