   ...
   async function saveCategory(ev){
    ...
    return(
        <Layout>
            ...
            value={name}
            >
                <option value='' >No parent category</option>                                                                                                                          q   {categories.length > 0 && categories.map(category=>(
               ...
               <label className="block">Properties</label>
                ...
                {properties.length >0 &&properties.map((property,index)=>(
                    <div className="flex gap-1 mb-2">
                        ...
                        placeholder="values,coma seperated"
                        />
                           ...
                           category=>(
                               <tr>
                                   ...
                                   <td>
                                       ...
                                       <button
                                        className="bg-red-600 px-3 text-white rounded-md py-1"
